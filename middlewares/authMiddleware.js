...
const authenticateToken = async (req, res, next) => {
    try {
        ...
        // Consulta la base de datos para obtener los datos completos y actualizados del usuario,
        // incluyendo el rol y la sede, usando INNER JOIN para obtener el nombre_rol.
